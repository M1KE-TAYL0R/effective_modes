...
fn plot_disp (prm: &Parameters,dispersion:Array2<f64>, omegas:Array1<f64>, thetas: Array1<f64>) {
    ...
    .set_x_ticks(Some((AutoOption::Fix(20.),3)), &[MajorScale(8.0),OnAxis(false),Inward(false),Mirror(false),MinorScale(4.0)], &[Font("Helvetica", 48.0), TextColor("black"), TextOffset(-0.85,-1.0)])
    .set_y_ticks(Some((AutoOption::Fix(0.1),5)), &[MajorScale(8.0),OnAxis(false),Inward(false),Mirror(false),MinorScale(4.0)], &[Font("Helvetica", 48.0), TextColor("black")])
    .set_cb_ticks(Some((Auto,5)),&[MajorScale(4.0),OnAxis(false),Inward(false),Mirror(false),MinorScale(2.0)], &[Font("Helvetica", 24.0), TextColor("black")])
    ...
    .set_margins(&[MarginLeft(0.12),MarginBottom(0.11), MarginRight(0.85), MarginTop(0.95)])
    .set_border(true, &[Bottom,Right,Left,Top], &[Color("black"),LineWidth(4.0)])
